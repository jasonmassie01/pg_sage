...
| **Query Tuning Beyond Hints** | Query rewrites, broken-hint retirement, and repeated role-level work_mem patterns become reviewable actions with verification steps |
